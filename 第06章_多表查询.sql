...
SELECT * 
FROM employees
WHERE last_name = 'Abel';  #得出Abel的department_id部门为80

SELECT * FROM departments
WHERE department_id = 80;  #得出Abel的location_id部门为2500

SELECT *
FROM locations
WHERE location_id = 2500;	#得出Abel的city部门为Oxford

#一次性写法使用 99版方式
SELECT e.last_name, l.city, l.`location_id`
FROM employees e JOIN departments d
ON e.`department_id` = d.`department_id`
JOIN locations l 
ON d.`location_id` = l.location_id
WHERE e.`last_name` = 'Abel';	#得出Abel的city部门为Oxford
