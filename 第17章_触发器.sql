...
BEGIN
	INSERT INTO test_trigger_log(t_log)
	VALUES(CONCAT(NOW(), '-auto fill in'));
END $
...
BEGIN
	...
	IF new.salary > mgr_sal
		THEN SIGNAL SQLSTATE 'HY000' SET MESSAGE_TEXT = '薪资高于领导薪资 错误';
...
VALUES(250, 'wggglggg', 'wggglggg@qqq.com', '2005-5-1', 'SH_CLERK', 1500, 120);

#添加失败
INSERT INTO employees(employee_id,last_name,email,hire_date,job_id,salary,manager_id)
VALUES(251, 'suisen', 'suisen@qqq.com', '2005-5-1', 'SH_CLERK', 9500, 120);
